...
import 'package:pro_fit/model/memberRepository.dart';
import 'package:pro_fit/model/memberSubscription.dart';
...
/*Future<void> setUserData(
    FirebaseAuth auth, String firstName, String lastName) async {
...
Future<void> setUserData(FirebaseAuth firebaseAuth, MemberRepository repository,
    String firstName, String lastName) async {
  var user = firebaseAuth.currentUser;
  if (user != null && firstName.isNotEmpty && lastName.isNotEmpty) {
    final newMember = Member(
      user.uid,
      firstName,
      lastName,
      DateTime.now(),
      memberCurrentSubscription: MemberSubscription(
          endDate: DateTime.now().add(const Duration(days: 365)),
          isCurrent: true,
          memberPackage:
              SubscriptionPackages(annualFee: "40000", packageName: "Gold"),
